...
<head>
    ...
    <title>Smart Logistics - Create Account</title>
    ...
    <div class="login-card">
        <div class="glass-card">
            ...
            <div class="card-content">
                    ...
                    <div class="logo-box">
                        <svg class="truck-svg" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                  d="M16 8h5l3 3v5h-2.5m-13.5 0h-3v-13"></path>
                ...
                <form action="${pageContext.request.contextPath}/register" method="POST" class="login-form">
                    ...
                    <div class="form-group">
                        <svg class="input-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                  d="M12 4a4 4 0 100 8 4 4 0 000-8zM6 20a6 6 0 0112 0"></path>
                        </svg>
                        <input type="text"
                               name="customer_name"
                    ...
                    <div class="form-group">
                        <svg class="input-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                  d="M3 8l9 6 9-6M4 6h16v12H4z"></path>
                        </svg>
                        <input type="email"
                               name="email"
                    ...
                    <div class="form-group">
                        <svg class="input-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                  d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2z"></path>
                        </svg>
                        <input type="password"
                               name="password"
                ...
                <!-- Back to Login -->
                <p style="text-align:center; margin-top:1rem; color:#e9d5ff;">
                    Already have an account?
                    <a href="${pageContext.request.contextPath}/login" style="color:white; font-weight:600;">
                        Login
                    </a>
                </p>
